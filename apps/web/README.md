...
│   └── search/page.tsx        → /polishes/search  3-column color workflow: wheel/source controls, harmonies + desired-color management, and filtered match table (right column on desktop) with status icons (Have/Buy/Virtual)
