  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden bg-gradient-hero py-24 sm:py-32 lg:py-40">
        ...
        <div
          className="pointer-events-none absolute -left-20 top-1/4 size-72 rounded-full opacity-30 blur-3xl"
          style={{ background: "#ff4fb8" }}
        />
        <div
          className="pointer-events-none absolute -right-20 bottom-1/4 size-80 rounded-full opacity-20 blur-3xl"
          style={{ background: "#7b2eff" }}
        />
        <div
          className="pointer-events-none absolute left-1/2 top-10 size-40 -translate-x-1/2 rounded-full opacity-25 blur-3xl"
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="glass group rounded-2xl p-8 transition-shadow hover:shadow-glow-brand"
              >
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {showcaseColors.map((color) => (
              <div
                key={color.name}
                className="group flex items-center gap-4 rounded-xl border border-border bg-card p-4 transition-shadow hover:shadow-glow-brand"
              >
                <div
