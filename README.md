...
| `/polishes/search` | `apps/web/src/app/polishes/search/page.tsx` | Color wheel search — two-column layout with vertical lightness, snap chip, focus workflow, and harmony recommendations |
