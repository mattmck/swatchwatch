...
| `PolishFinish` | Union of finish types: `"creme" \| "shimmer" \| "glitter" \| "metallic" \| "matte" \| "jelly" \| "holographic" \| "duochrome" \| "multichrome" \| "flake" \| "topper" \| "sheer" \| "magnetic" \| "thermal" \| "crelly" \| "other"` |
